...
def parse_argument():
    ...
    parser.add_argument('--url', type=str, required=False, default='localhost:8001',
...
if __name__ == '__main__':
    ...
    if opt.video_save_path:
        ...
        video = cv2.VideoWriter(opt.video_save_path,
    ...
    while cap.isOpened():
        ...
        frame = postprocess(rs_image, InferResult(
            response).as_numpy(output_name), labels, opt.model)
